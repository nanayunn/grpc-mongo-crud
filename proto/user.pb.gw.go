...
var (
	...
	pattern_UserService_ReadUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"readuser"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_UserService_UpdateUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user.UserService", "UpdateUser"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_UserService_DeleteUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user.UserService", "DeleteUser"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_UserService_ListUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user.UserService", "ListUser"}, "", runtime.AssumeColonVerbOpt(true)))
)
